...
const T = {
  fr: {
    ...
    'tip.title': 'Astuce',
    'tip.0': "Câliner régulièrement un dragon renforce ton lien avec lui — jusqu'à débloquer des bonus liés à son tempérament.",
    'tip.1': "Chaque dragon a un tempérament unique (Joueur, Calme...) qui lui donne un petit bonus concret en jeu.",
    'tip.2': "Ton sanctuaire a 3 emplacements de décoration — personnalise-le depuis la Boutique.",
    'tip.3': "Marque tes dragons préférés en Favoris pour les retrouver plus vite dans une grande collection.",
    'tip.4': "Au Laboratoire, associe deux dragons adultes pour obtenir un œuf inattendu.",
    'tip.5': "Depuis la fiche d'un dragon, tu peux télécharger sa carte pour la partager.",
    ...
    'carte.nextStop': 'Prochaine étape',
    ...
    'carte.scoutTitle': 'Repérer le terrain',
    'carte.scoutTap': 'Tape au bon moment ({n}/{max})',
    'carte.scoutDoneBonus': 'Bon œil ! +{n}% d\'écailles pour cette expédition.',
    'carte.scoutDoneNone': 'Terrain repéré, sans bonus cette fois — l\'expédition reste inchangée.',
    ...
    'carte.eggChanceHint': '{n}% de chance de revenir avec un œuf',
    ...
    'labo.tipTitle': 'Le sais-tu ?',
    'labo.tipBody': 'L\'œuf hérite presque toujours de l\'élément de l\'un des deux parents. Unis deux dragons légendaires, et le mythique n\'est plus tout à fait hors de portée — même un élevage qui rate rapproche du suivant.',
    ...
    'toast.expeditionLaunchedScouted': 'Expédition lancée avec +{n}% d\'écailles grâce à ton repérage !',
  ...
  en: {
    ...
    'tip.title': 'Tip',
    'tip.0': 'Cuddling a dragon regularly strengthens your bond with it — eventually unlocking perks tied to its temperament.',
    'tip.1': 'Every dragon has a unique temperament (Playful, Calm...) that gives it a small, concrete in-game perk.',
    'tip.2': 'Your sanctuary has 3 decoration slots — personalize it from the Shop.',
    'tip.3': 'Mark your favorite dragons to find them faster in a large collection.',
    'tip.4': 'At the Lab, pair two adult dragons to get a surprise egg.',
    'tip.5': "From a dragon's detail page, you can download its card to share it.",
    ...
    'carte.scoutTitle': 'Scout the terrain',
    'carte.scoutTap': 'Tap at the right moment ({n}/{max})',
    'carte.scoutDoneBonus': 'Good eye! +{n}% scales for this expedition.',
    'carte.scoutDoneNone': 'Terrain scouted, no bonus this time — the expedition stays unchanged.',
    ...
    'carte.eggChanceHint': '{n}% chance of coming back with an egg',
    'carte.claim': 'Collect',
    ...
    'labo.tipTitle': 'Did you know?',
    'labo.tipBody': 'The egg almost always inherits one parent\'s element. Pair two legendary dragons and a mythic isn\'t entirely out of reach — even a failed pairing brings the next one closer.',
    ...
    'toast.expeditionLaunchedScouted': 'Expedition launched with +{n}% scales from your scouting!',
